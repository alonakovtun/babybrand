...
{
    wp_enqueue_style('baby-style', get_stylesheet_uri(), array(), _S_VERSION);
    wp_enqueue_style('baby-style-default', get_template_directory_uri() . '/assets/css/main.min.css', array(), _S_VERSION);

    wp_enqueue_script('feather', get_template_directory_uri() . '/assets/js/main.min.js', array(), _S_VERSION, true);
}
