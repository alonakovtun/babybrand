...
add_action( 'woocommerce_review_order_after_order_total', 'custom_display_payments', 20 );

/**
 * Displaying the Payment Gateways 
 */
function custom_display_payments() {
    if (!is_ajax()) {
...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<div class="form-row place-order">
		...
		<?php echo apply_filters( 'woocommerce_order_button_html', '<div class="item-checkout__buttons"><button type="submit" disabled class="button alt item-checkout__button" name="woocommerce_checkout_place_order" id="place_order" value="pay" data-value="pay">pay</button></div>' ); // @codingStandardsIgnoreLine ?>
...
<div class="item-checkout__radiobtns">
    <input class="item-checkout__radio notactive" onchange="jQuery('#place_order').removeAttr('disabled')" type="radio" name="">
