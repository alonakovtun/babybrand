...
<main class="main">
	<div class="accountdetails__container">
		<div class="accountdetails__body">
			...
			<div class="accountdetails__column item-details">
				...
				<form class="woocommerce-EditAccountForm edit-account item-details__form mt-65" action="" method="post" <?php do_action('woocommerce_edit_account_form_tag'); ?>>
					...
					<div class="item-details__title"><?php esc_html_e('Password', 'woocommerce'); ?></div>

						

						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
							<!-- <label for="password_current"><?php esc_html_e('Current password (leave blank to leave unchanged)', 'woocommerce'); ?></label> -->
							<input placeholder="<?php esc_html_e('Current password', 'woocommerce'); ?>" type="password" class="woocommerce-Input woocommerce-Input--password input-text" name="password_current" id="password_current" autocomplete="off" />
						</p>
						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
							<!-- <label for="password_1"><?php esc_html_e('New password (leave blank to leave unchanged)', 'woocommerce'); ?></label> -->
							<input placeholder="<?php esc_html_e('New password', 'woocommerce'); ?>" type="password" class="woocommerce-Input woocommerce-Input--password input-text" name="password_1" id="password_1" autocomplete="off" />
						</p>
						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
					...
					<p>
						...
						<button type="submit" class="woocommerce-Button button accountdetails__button" name="save_account_details" value="<?php esc_attr_e('Save changes', 'woocommerce'); ?>"><?php esc_html_e('Save changes', 'woocommerce'); ?></button>
