...
if ($product->is_in_stock()) : ?>
	...
	<div class="">
		<form class="cart " action="<?php echo esc_url(apply_filters('woocommerce_add_to_cart_form_action', $product->get_permalink())); ?>" method="post" enctype='multipart/form-data'>
			...
			?>
			<div class="add_btn">
					<button type="submit" name="add-to-cart" value="<?php echo esc_attr($product->get_id()); ?>" class="main_btn_area item-cart item-cart__text single_add_to_cart_button button alt item-cart__text"><?php echo esc_html('Add to Cart', 'baby-brand'); ?></button>
