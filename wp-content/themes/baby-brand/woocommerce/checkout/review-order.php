          ...
          <div class="cart-item__info flex js-space fl-column">
            <div class="cart-item__head flex jc-space al-start flex1">
              <div class="support-box">
                ...
                <?php if (!empty(get_field('czas_realizacji', $product_id))) : ?>
                  <p class=" txt-14 lh-24 mb-40">Czas Realizacji: <?php the_field('czas_realizacji', $product_id); ?></p>
                <?php else: ?>
                  <p class=" txt-14 lh-24 mb-40">Brak terminu realizacji</p>
                <?php endif; ?>
