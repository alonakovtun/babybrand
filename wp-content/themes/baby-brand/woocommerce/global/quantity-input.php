...
?>
	...
	<div class="quantity item-settings">
		<?php do_action('woocommerce_before_quantity_input_field'); ?>
		<div class="quantity">
			<label class="screen-reader-text" for="<?php echo esc_attr($input_id); ?>"><?php esc_html_e('Quantity', 'woocommerce'); ?></label>
			<div class="item-settings__name link"><?php _e('Quantity:', 'baby-brand')?></div>
			...
			<input type="submit" value="-" name="update_cart" class="qty_button minus" />
			<input type="submit" value="+" name="update_cart" class="qty_button plus" />
		</div>
