		...
		?>
			<tr valign="top" <?php echo $form_toggler_child; ?>>
			    ...
			    <td style="<?php if($field_id == "woocommerce_wf_generate_for_taxstatus"){echo 'width:55%;'; }?>">
					...
					{
					?>
			       		<textarea <?php echo $fld_attr;?> name="<?php echo $field_name;?>" class="<?php echo $field_class; ?>" placeholder="<?php echo $field_placeholder; ?>" id="<?php echo $field_id; ?>"><?php echo $vl;?></textarea>
			        <?php
					...
					elseif($type=='radio') //radio button
					{
						...
						?>
						<input type="radio" id="<?php echo $field_id.'_'.$rad_vl;?>" name="<?php echo $field_name;?>" class="<?php echo $form_toggler_p_class;?>" <?php echo $form_toggler_register;?> value="<?php echo $rad_vl;?>" <?php echo $checked_attr; ?> <?php echo $fld_attr;?> /> <?php echo $rad_label; ?>
						&nbsp;&nbsp;
						<?php
						}
